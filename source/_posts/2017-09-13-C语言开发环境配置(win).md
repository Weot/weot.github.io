...
![sublime text3效果图](/images/2017-09-13/00sublime text3效果图.png)
...
![Cmder运行效果图](/images/2017-09-13/01Cmder运行效果图.png)
...
1. tcc 下载解压后放到任意文件夹, 添加tcc路径到PATH环境变量:
    ...
    解压到任意文件夹
    ![解压到任意文件夹](/images/2017-09-13/02解压到任意文件夹.png)
    添加tcc到环境变量path
    ![添加tcc到环境变量path](/images/2017-09-13/03添加tcc到环境变量path.png)
2. 现在命令行窗口键入`tcc`, 有类似下面的显示, 说明配置好了

    ![tcc运行图](/images/2017-09-13/04tcc运行图.png)
...
![sublime text3与tcc运行效果图](/images/2017-09-13/05sublime text3与tcc运行效果图.png)
